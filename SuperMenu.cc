  ...
  : QMenuBar( parent )
{
  ...
  /*openRecent = fileMenu->addMenu( tr( "Open recent" ) ); */
  ...
  viewWPTagsAction = viewMenu->addAction( tr( "Ta&gs" ) );
  ...
  addWPTagAction = servicesMenu->addAction( tr( "Add tag ..." ) );
  removeWPTagAction = servicesMenu->addAction( tr( "Remove this tag" ) );
  refreshWPTagsAction = servicesMenu->addAction( tr( "Refresh tags" ) );
  ...
  viewPingsAction->setShortcut( QKeySequence( "Ctrl+5" ) );
...
void SuperMenu::choose( QString fname )
{
  ...
  EditingWindow *activeWin = qobject_cast<EditingWindow *>( qtm->activeWindow() );
  QSettings settings;
...
void SuperMenu::getPreferences()
{
  ...
  QString editorFontString, previewFontString, consoleFontString,
          defaultEditorFontString, defaultPreviewFontString, defaultConsoleFontString;
  ...
  if( QSysInfo::macVersion() <= QSysInfo::MV_10_9 ) {
    defaultEditorFontString = QFont( "Lucida Grande", 13 ).toString();
    defaultPreviewFontString = QFont( "Lucida Grande", 13 ).toString();
  }
  else {
    defaultEditorFontString = QFont( "Helvetica Neue", 13 ).toString();
    defaultPreviewFontString = QFont( "Helvetica Neue", 13 ).toString();
  }
  defaultConsoleFontString = QFont( "Andale Mono", 13 ).toString();
#else
  ...
  if( currentWindow )
    prefsDialog.setParent( currentWindow );
