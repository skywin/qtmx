  ...
  : QDialog( parent )
{
  ...
  // On Mac and Unity, there is always a new window at startup and on Unity,
  // there is only one mouse action available in the system tray (which
  // shows the context menu). So these options are redundant.
#ifdef Q_OS_MAC
